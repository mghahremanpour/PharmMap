...
##TODO: add timer to see how long the training takes
...
##TODO: output .csv with the following: SMILES, ID, active probability, inactive probability, confidence (e.g. maximum similarity to training set)
